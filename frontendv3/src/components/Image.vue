<template>
  <div class="position-absolute top-0 start-0 select-none"
    :style="{
        width: `${width + dw}px`,
...
>
    <div
        class="position-absolute w-100 h-100 cursor-grab"
        :class="[
    ...
    >
        ...
        <div
            ...
            class="position-absolute cursor-nwse-resize transform selector"
            style="top: 0%; left: 0%;"
        ></div>
        <div
            data-direction="right-top"
            class="position-absolute cursor-nesw-resize transform selector"
    ...
    <div
        class="position-absolute cursor-pointer transform delete"
        style="top: 0%; left: 50%;"
        @click="onDelete"
    >
        <img class="w-100 h-100" src="/delete.svg" alt="delete object" />
    </div>
    <canvas
        ref="imgCanvas"
        class="w-100 h-100 border border-gray-400 border-dashed"
    ></canvas>
</div>
...
<script>
import itemEventsMixin from "../components/ItemEventsMixin.vue";
