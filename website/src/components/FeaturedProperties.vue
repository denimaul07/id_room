<template>
    <section class="py-20 bg-base-200">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h2 class="text-4xl font-bold text-gray-900 text-center md:text-left">
                        Properti Unggulan untuk Dijual
                    </h2>
            ...
            <!-- Grid -->
            <div v-else-if="pagedProperties.length > 0" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div v-for="property in pagedProperties" :key="property.id"
                    ...
                    <div class="p-5 flex-1 flex flex-col">
                        ...
                        <div class="flex justify-center">
                            <router-link :to="{ path: '/sell-details', query: { odata: property.id } }"
                                class="btn btn-primary btn-sm bg-black text-center text-white w-40 rounded-full mt-4">
                                View Details
                            </router-link>
                        </div>
                    </div>
            ...
            <div v-else class="flex justify-center items-center">
                <div class="text-center text-gray-500">
                    <img src="/src/assets/404/404.svg" alt="No properties" class="mx-auto mb-4" />
                    <p class="text-lg">Tidak ada properti untuk ditampilkan.</p>
                </div>
            </div>
            <!-- Explore All Button -->
            <div class="flex justify-center mt-8" v-if="pagedProperties.length > 0">
                <!-- Explore All Button -->
                <div class="flex justify-center mt-8">
                    <router-link to="/jual-properti"
...
const filteredProperties = computed(() => {
    return rawProperties.value.filter((item) => {
        ...
        return types.length === 0 ? true : types.includes('sale')
    })
})
