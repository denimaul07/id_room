<template>
  <button
    ...
    @click="scrollToTop"
    class="fixed bottom-8 right-8 z-50 w-12 h-12 rounded-full bg-[#d5bd7d] text-white flex items-center justify-center shadow-lg hover:bg-[#bfa94f] transition-all duration-200"
