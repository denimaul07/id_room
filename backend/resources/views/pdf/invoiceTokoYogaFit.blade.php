        ...
        <table id="table" style="font-size: 12px">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $data->penjualan->customers_name }}</td>
                ...
                <tr>
                    <td colspan="9" style="text-align: center;"><strong>TOTAL SALES </strong></td>
                    <td style="text-align: left;"><strong>Rp. {{ number_format($total, 0, ',', '.') }}</strong></td>
                </tr>

                <tr>
                    <td colspan="9" style="text-align: center;"><strong>TOTAL COMMISSION 5% </strong></td>
                    <td style="text-align: left;"><strong>Rp. {{ number_format($total - ($total * (1 - 5 / 100)), 0, ',', '.') }}</strong></td>
                </tr>

                <tr>
                    <td colspan="9" style="text-align: center;"><strong>TOTAL AMOUNT DUE FOR {{ $bulan}} </strong></td>
                    <td style="text-align: left;"><strong>Rp. {{ number_format($total - ($total - ($total * (1 - 5 / 100))), 0, ',', '.') }}</strong></td>
                </tr>
